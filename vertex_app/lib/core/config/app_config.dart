...
class AppConfig {
  ...
  static const String vercelApiBaseUrl = 'https://vertex-ids-srs-classification-backend.vercel.app';
  ...
  static String _resolveApiBaseUrl() {
    ...
    const useLocalDev = String.fromEnvironment('USE_LOCAL_DEV', defaultValue: 'false');
    if (useLocalDev == 'true') {
